...
window.YAPPY_DECKS = {
  ...
  crousti: {
    ...
    questions: [
      ...
      "Entre la personne à ta gauche et celle à ta droite, qui a le plus de chances de te voir nu un jour ?",
      ...
      "Qui ici gère ton argent pendant un mois, qui gère tes dates, et qui prend tes décisions pro ?",
      "Entre la personne à ta gauche et celle à ta droite, avec qui tu pars en vacances, et avec qui tu montes un business ?",
      ...
      "Entre la personne à ta gauche et celle à ta droite, qui a probablement les kinks les plus inattendus ?",
