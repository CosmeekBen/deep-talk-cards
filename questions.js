...
window.YAPPY_DECKS = {
  ...
  deep: {
    ...
    questions: [
      ...
      "Qu'est-ce que les gens pensent de toi qui est faux ?",
  ...
  crousti: {
    ...
    questions: [
      ...
      "De qui tu as eu une mauvaise première impression ici ?",
      ...
      "Ton moins bon fit dans la maison ?",
      ...
      "Qui ici t'a déjà agacé sans jamais s'en rendre compte ?",
      ...
      "Avec qui ici tu ne partirais pas en vacances ?",
      ...
      "Quel comportement chez quelqu'un ici tu ne supporterais pas au quotidien ?",
